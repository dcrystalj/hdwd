from .main import get_account_private_key, get_account_public_key, get_receiving_addresses, get_new_mnemonic
...
def test_get_recieving_addresses():
    assert get_receiving_addresses(words, "english", "my supper duper passphrase", 1, 3) == [
